...
#else
enum CONTROLLERENUM {FORWARDS = 0, BACKWARDS, STRAFELEFT, STRAFERIGHT, FIRE, AIM, RELOAD, ACCEPT, CANCEL, START, CROUCH, KNEEL, PREVIOUSWEAPON, NEXTWEAPON, UP, DOWN, LEFT, RIGHT, D_UP, D_DOWN, D_LEFT, D_RIGHT, L_SHOULDER, R_SHOULDER, TOTALBUTTONS};
#endif
